...
class TrigramTagger:
    """
    Class to tag words using the Viterbi algorithm on Trigrams.
    """
    ...
    def build_viterbi_dicts(self, sentence):
        ...
        for k in range(1, len(sentence)+1):
            #replace word with _RARE_ if used less than 5 times in training file
...
def usage():
    print """
    python trigram_tagger.py [counts_file] [input_file] > [output_file]
    """
